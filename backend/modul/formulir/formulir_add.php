<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang["add_button"];?> Formulir</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?php echo $lang["add_button"];?> Formulir</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_formulir" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/formulir/formulir_action.php?act=in">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="no_hp" placeholder="Nomor HP (whatsapp)" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-10">
                <input type="text" data-rule-number="true" name="nik" placeholder="NIK" class="form-control" required>
              </div>
          </div><!-- /.form-group -->
          ...
          <div class="form-group">
              ...
              <div class="col-lg-3">
                <div class="input-group date tgl_picker">
                    <input type="text" autocomplete="off" class="form-control tgl_picker_input" name="tgl_lahir" required />
