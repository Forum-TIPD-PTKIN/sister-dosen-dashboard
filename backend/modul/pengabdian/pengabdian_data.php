...
$query = $datatable->execQuery("select tb_ref_sdm.nama_sdm,judul,tb_data_pengabdian.tahun_pelaksanaan,tb_data_pengabdian.lama_kegiatan,tb_data_pengabdian.id from tb_data_pengabdian inner join tb_ref_sdm on tb_data_pengabdian.id_sdm=tb_ref_sdm.id_sdm", $columns);
