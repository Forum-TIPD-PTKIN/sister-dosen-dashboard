...
$data_edit = $db->fetchSingleRow("reference_data","id",$_POST['id_data']);
?>
   <div class="alert alert-danger error_data" style="display:none">
          <button type="button" class="close" data-dismiss="alert">&times;</button>
          <span class="isi_warning"></span>
        </div>
            <form id="edit_referensi_data" method="post" class="form-horizontal" action="<?=base_admin();?>modul/referensi_data/referensi_data_action.php?act=up">
                            
              <div class="form-group">
                <label for="reference_type" class="control-label col-lg-2">reference_type <span style="color:#FF0000">*</span></label>
                <div class="col-lg-10">
                  <input type="text" name="reference_type" value="<?=$data_edit->reference_type;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="reference_id" value="<?=$data_edit->reference_id;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
              ...
              <div class="form-group">
                ...
                <div class="col-lg-10">
                  <input type="text" name="data" value="<?=$data_edit->data;?>" class="form-control" required>
                </div>
              </div><!-- /.form-group -->
