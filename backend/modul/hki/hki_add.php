<!-- Content Header (Page header) -->
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?php echo $lang["add_button"];?> Hki</li>
        </ol>
    </section>
      ...
      <div class="col-lg-12">
        <div class="box box-solid box-primary">
          <div class="box-header">
            <h3 class="box-title"><?php echo $lang["add_button"];?> Hki</h3>
          ...
          <span class="isi_warning"></span>
            ...
            <form id="input_hki" method="post" class="form-horizontal foto_banyak" action="<?=base_admin();?>modul/hki/hki_action.php?act=in">
